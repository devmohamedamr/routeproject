...
$data = $feature->getFeatureById($_GET['id']);

if(isset($_POST['title'])){
    $_POST['status'] = ($_POST['status'] == 'on') ? 1 : 0;

    $feature->updateFeature($_POST);
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="updatefeature.php" method="post" class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" value="<?= $data['description']; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">icon</label>
                            <input type="text" name="icon" value="<?= $data['icon']; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
